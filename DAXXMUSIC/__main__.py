...
async def init():
    ...
    await DAXX.start()
    try:
        await DAXX.stream_call("https://telegra.ph/file/843c6ade6940ed9eabb93.jpg")
    except NoActiveGroupCall:
        LOGGER("DAXXMUSIC").error(
            "𝗣𝗹𝗭 𝗦𝗧𝗔𝗥𝗧 𝗬𝗢𝗨𝗥 𝗟𝗢𝗚 𝗚𝗥𝗢𝗨𝗣 𝗩𝗢𝗜𝗖𝗘𝗖𝗛𝗔𝗧\𝗖𝗛𝗔𝗡𝗡𝗘𝗟\n\n🥀 ⃪ͥ͢ ᷟ🅒̣̣̣ɼͧūᷢ𝛅ի🥂🅢︎нεкнαг•♡ 𝗕𝗢𝗧 𝗦𝗧𝗢𝗣........"
        )
        exit()
    except:
        pass
    ...
    LOGGER("DAXXMUSIC").info(
        "╔═════ஜ۩۞۩ஜ════╗\n  ☠︎︎𝗠𝗔𝗗𝗘 𝗕𝗬 🥀 ⃪ͥ͢ ᷟ🅒̣̣̣ɼͧūᷢ𝛅ի🥂🅢︎нεкнαг•♡☠︎︎\n╚═════ஜ۩۞۩ஜ════╝"
    )
    await idle()
    await app.stop()
    await userbot.stop()
    LOGGER("DAXXMUSIC").info("𝗦𝗧𝗢𝗣 🥀 ⃪ͥ͢ ᷟ🅒̣̣̣ɼͧūᷢ𝛅ի🥂🅢︎нεкнαг•♡ 𝗠𝗨𝗦𝗜𝗖🎻 𝗕𝗢𝗧..")
